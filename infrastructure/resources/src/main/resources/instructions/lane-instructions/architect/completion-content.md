# Architect Completion Content

Build only the final completion payload needed to route implementation, API, and event lanes.

Use factual architect outputs only:
- implementation handoff;
- API required/not-required decision;
