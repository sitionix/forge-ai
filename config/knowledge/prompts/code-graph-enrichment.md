# 1. Task
Enrich one source code file for a local structural knowledge graph.
...
Do not derive, append, shorten, split, normalize, or invent anchor keys from code symbols, filenames, comments, line numbers, or paths.
