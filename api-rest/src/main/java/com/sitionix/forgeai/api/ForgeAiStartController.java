...
public class ForgeAiStartController implements ForgeAiApi {
    ...
    @Override
    public ResponseEntity<StartForgeResponseDTO> startForge(final StartForgeRequestDTO startForgeRequestDTO) {
