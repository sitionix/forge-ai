...
class AnalysisRuntimeContext:
    ...
    previous_response_available: Optional[bool] = None
    previous_response_preview_truncated: Optional[bool] = None
    previous_response_preview_length: Optional[int] = None
