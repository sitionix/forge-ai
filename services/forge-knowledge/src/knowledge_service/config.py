...
from knowledge_service.knowledge_defaults import knowledge_module_dir, knowledge_sources_path, load_knowledge_defaults, resolve_config_path
...
def load_app_config() -> AppConfig:
    ...
    store = resolve_config_path(
        str(os.environ.get("KNOWLEDGE_STORE_PATH") or inventory.get("store_path") or "${FORGE_RUNTIME_DIR}/knowledge/knowledge.sqlite"),
    ...
    return AppConfig(
        ...
        local_config_path=knowledge_sources_path(module_dir),
        store_path=store,
