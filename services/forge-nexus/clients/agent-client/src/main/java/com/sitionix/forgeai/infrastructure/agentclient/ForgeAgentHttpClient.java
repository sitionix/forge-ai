...
public interface ForgeAgentHttpClient {
    ...
    @PostExchange("/api/v1/integrations/mcp/connections/{id}/test") com.sitionix.forgeai.infrastructure.agentclient.dto.McpProbeInboundResponse testMcpConnection(@PathVariable UUID id);
    @GetExchange("/api/v1/integrations/mcp/connections/{id}/tools") java.util.List<com.sitionix.forgeai.infrastructure.agentclient.dto.McpProbeInboundResponse.Tool> listMcpTools(@PathVariable UUID id);
    @PutExchange(value="/api/v1/integrations/mcp/connections/{id}/allowed-tools",contentType=MediaType.APPLICATION_JSON_VALUE) com.sitionix.forgeai.infrastructure.agentclient.dto.McpConnectionInboundResponse approveMcpTools(@PathVariable UUID id,@RequestBody ForgeAgentMcpClientAdapter.Approvals request);
    ...
    @PutExchange(value="/api/v1/projects/{projectId}/assets/{assetId}/monitoring",contentType=MediaType.APPLICATION_JSON_VALUE) List<AgentLogSourceResponse> replaceProjectAssetMonitoring(@PathVariable UUID projectId,@PathVariable UUID assetId,@RequestBody com.sitionix.forgeai.infrastructure.agentclient.dto.AssetMonitoringReplacementRequest request);
