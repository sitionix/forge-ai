...
public interface ForgeAgentHttpClient {
  ...
  @PostExchange(
      value = "/api/v1/projects/{projectId}/repositories",
      contentType = MediaType.APPLICATION_JSON_VALUE)
  ProjectRepositoryResponse importProjectRepository(
      @PathVariable UUID projectId, @RequestBody ImportProjectRepositoryRequest request);
  ...
  ProjectRepositoryResponse cloneProjectRepository(
      @PathVariable UUID projectId, @PathVariable UUID repositoryId);

  @PostExchange("/api/v1/projects/{projectId}/repositories/{repositoryId}/refresh")
  ProjectRepositoryResponse refreshProjectRepository(
      @PathVariable UUID projectId, @PathVariable UUID repositoryId);

  @PostExchange("/api/v1/projects/{projectId}/repositories/{repositoryId}/pull")
  ProjectRepositoryResponse pullProjectRepository(
      @PathVariable UUID projectId, @PathVariable UUID repositoryId);

  @PostExchange(
      value = "/api/v1/projects/{projectId}/tasks",
      contentType = MediaType.APPLICATION_JSON_VALUE)
  ProjectTaskResponse createProjectTask(
      @PathVariable UUID projectId, @RequestBody CreateProjectTaskRequest request);

  @GetExchange("/api/v1/projects/{projectId}/tasks")
  ProjectTaskPageResponse listProjectTasks(
      @PathVariable UUID projectId, @RequestParam int page, @RequestParam int size);
  ...
  @PostExchange(
      value = "/api/v1/projects/{projectId}/agents",
      contentType = MediaType.APPLICATION_JSON_VALUE)
  AgentDefinitionResponse createAgent(
      @PathVariable UUID projectId, @RequestBody AgentDefinitionRequest request);
  ...
  AgentDefinitionResponse updateAgent(
      @PathVariable UUID agentId, @RequestBody AgentDefinitionRequest request);
  ...
  @PostExchange(
      value = "/api/v1/projects/{projectId}/workflows",
      contentType = MediaType.APPLICATION_JSON_VALUE)
  AgentWorkflowResponse createWorkflow(
      @PathVariable UUID projectId, @RequestBody AgentWorkflowRequest request);

  @GetExchange("/api/v1/workflows/{workflowId}")
  AgentWorkflowResponse getWorkflow(@PathVariable UUID workflowId);

  @PutExchange(
      value = "/api/v1/workflows/{workflowId}",
      contentType = MediaType.APPLICATION_JSON_VALUE)
  AgentWorkflowResponse updateWorkflow(
      @PathVariable UUID workflowId, @RequestBody SaveAgentWorkflowRequest request);

  @DeleteExchange("/api/v1/workflows/{workflowId}")
  void deleteWorkflow(@PathVariable UUID workflowId);

  @PostExchange(
      value = "/api/v1/workflows/{workflowId}/runs",
      contentType = MediaType.APPLICATION_JSON_VALUE)
  WorkflowRunResponse createWorkflowRun(
      @PathVariable UUID workflowId, @RequestBody CreateWorkflowRunRequest request);
