...
public class CloneAgentProjectRepositoryUseCase implements CloneAgentProjectRepository {
    ...
    public AgentProjectRepository execute(final UUID projectId, final UUID repositoryId) {
        return this.forgeAgentClient.cloneProjectRepository(projectId, repositoryId);
    }
}
