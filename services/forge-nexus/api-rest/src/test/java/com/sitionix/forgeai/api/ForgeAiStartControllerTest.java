...
class ForgeAiStartControllerTest {

    private ForgeAiStartController forgeAiStartController;
    ...
    @BeforeEach
    void setUp() {
        this.forgeAiStartController = new ForgeAiStartController(
    ...
    void givenValidStartForgeRequestDTO_whenStartForge_thenReturnCreatedResponseEntity() {
        ...
        final ResponseEntity<StartForgeResponseDTO> actual = this.forgeAiStartController.startForge(requestDTO);
