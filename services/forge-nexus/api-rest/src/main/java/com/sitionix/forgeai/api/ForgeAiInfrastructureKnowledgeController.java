...
public class ForgeAiInfrastructureKnowledgeController {
    ...
    public CompletableFuture<ResponseEntity<?>> sources(@RequestHeader final HttpHeaders headers,
                                                        final HttpServletRequest request) {
        return this.proxy("knowledge.sources", Map.of(), null, headers, request);
    }

    @GetMapping("/api/v1/infrastructure/knowledge/overview")
    public CompletableFuture<ResponseEntity<?>> overview(@RequestHeader final HttpHeaders headers,
                                                         final HttpServletRequest request) {
    ...
    public CompletableFuture<ResponseEntity<?>> buildInventory(@RequestBody(required = false) final JsonNode body,
    ...
    public CompletableFuture<ResponseEntity<?>> inventoryStatus(@RequestHeader final HttpHeaders headers,
                                                                final HttpServletRequest request) {
    ...
    public CompletableFuture<ResponseEntity<?>> files(@RequestHeader final HttpHeaders headers,
                                                      final HttpServletRequest request) {
    ...
    public CompletableFuture<ResponseEntity<?>> buildAnalysis(@RequestBody(required = false) final JsonNode body,
                                                              @RequestHeader final HttpHeaders headers,
                                                              final HttpServletRequest request) {
    ...
    public CompletableFuture<ResponseEntity<?>> retryFailedAnalysis(@RequestBody(required = false) final JsonNode body,
                                                                    @RequestHeader final HttpHeaders headers,
                                                                    final HttpServletRequest request) {
    ...
    public CompletableFuture<ResponseEntity<?>> analysisJob(@PathVariable final String jobId,
                                                            @RequestHeader final HttpHeaders headers,
                                                            final HttpServletRequest request) {
    ...
    public CompletableFuture<ResponseEntity<?>> stopAnalysis(@PathVariable final String jobId,
                                                             @RequestBody(required = false) final JsonNode body,
                                                             @RequestHeader final HttpHeaders headers,
                                                             final HttpServletRequest request) {
    ...
    public CompletableFuture<ResponseEntity<?>> analysisStatus(@RequestHeader final HttpHeaders headers,
                                                               final HttpServletRequest request) {
    ...
    public CompletableFuture<ResponseEntity<?>> analysisCurrentFileProgress(@RequestHeader final HttpHeaders headers,
                                                                           final HttpServletRequest request) {
    ...
    public CompletableFuture<ResponseEntity<?>> analysisFiles(@RequestHeader final HttpHeaders headers,
                                                              final HttpServletRequest request) {
    ...
    public CompletableFuture<ResponseEntity<?>> analysisDiagnostics(@RequestHeader final HttpHeaders headers,
                                                                   final HttpServletRequest request) {
    ...
    public CompletableFuture<ResponseEntity<?>> analysisGraphMetadata(@RequestHeader final HttpHeaders headers,
                                                                     final HttpServletRequest request) {
    ...
    public CompletableFuture<ResponseEntity<?>> analysisGraphManifest(@RequestHeader final HttpHeaders headers,
                                                                     final HttpServletRequest request) {
    ...
    public CompletableFuture<ResponseEntity<?>> analysisGraphView(@RequestHeader final HttpHeaders headers,
                                                                 final HttpServletRequest request) {
    ...
    public CompletableFuture<ResponseEntity<?>> analysisGraphNodes(@RequestHeader final HttpHeaders headers,
                                                                  final HttpServletRequest request) {
    ...
    public CompletableFuture<ResponseEntity<?>> analysisGraphEdges(@RequestHeader final HttpHeaders headers,
                                                                  final HttpServletRequest request) {
    ...
    public CompletableFuture<ResponseEntity<?>> analysisGraphNode(@PathVariable final String nodeId,
                                                                 @RequestHeader final HttpHeaders headers,
                                                                 final HttpServletRequest request) {
    ...
    public CompletableFuture<ResponseEntity<?>> analysisGraphEdge(@PathVariable final String edgeId,
                                                                 @RequestHeader final HttpHeaders headers,
                                                                 final HttpServletRequest request) {
    ...
    private CompletableFuture<ResponseEntity<?>> proxy(final String route,
                                                       ...
                                                       final HttpServletRequest request) {
        return this.proxyTransport.forwardJson(route, pathVariables, body, JsonNode.class, headers, request);
    }
}
