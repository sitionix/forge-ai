...
public record AgentExecutionContextResponse(UUID sessionId, UUID turnId, UUID nodeRunId, UUID sourceNodeId,
        UUID repositoryId, String contextMode, Integer sequence, String sessionStatus, String turnStatus,
        ...
        UUID forkedFromSessionId, UUID forkedFromTurnId, boolean forkAllowed, String forkReason) {
