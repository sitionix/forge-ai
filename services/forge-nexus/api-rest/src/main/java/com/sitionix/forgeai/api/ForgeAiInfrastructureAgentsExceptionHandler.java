...
public class ForgeAiInfrastructureAgentsExceptionHandler {
  ...
  public ResponseEntity<InfrastructureErrorResponse> handleAgentClientException(
      final AgentClientException exception) {
    final int statusCode = exception.statusCode();
    if (statusCode < 100 || statusCode > 599) {
      return this.response(
          HttpStatus.BAD_GATEWAY, "UPSTREAM_ERROR", "Forge Agent request failed.", null);
    }
  ...
  public ResponseEntity<InfrastructureErrorResponse> handleInvalidUpstreamResponse(
  ...
  public ResponseEntity<InfrastructureErrorResponse> handleBadRequest(
      final HttpMessageNotReadableException exception) {
    return this.response(
        HttpStatus.BAD_REQUEST, "VALIDATION_FAILED", "Agent request is invalid.", null);
  }

  @ExceptionHandler(MethodArgumentNotValidException.class)
  public ResponseEntity<InfrastructureErrorResponse> handleValidation(
  ...
  private ResponseEntity<InfrastructureErrorResponse> response(
