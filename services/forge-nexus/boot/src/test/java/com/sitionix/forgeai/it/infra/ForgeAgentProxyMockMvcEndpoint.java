...
public final class ForgeAgentProxyMockMvcEndpoint {
    ...
    public static Endpoint<Void, AgentProjectRepositoryResponse> checkProjectRepositoryUpdates() {
        return Endpoint.createContract("/api/v1/infrastructure/agents/projects/{projectId}/repositories/{repositoryId}/check-updates",
                HttpMethod.POST,
                Void.class,
                AgentProjectRepositoryResponse.class,
                (MockmvcDefault) context -> context
