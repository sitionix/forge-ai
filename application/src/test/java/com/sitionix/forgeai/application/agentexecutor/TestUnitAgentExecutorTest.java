...
class TestUnitAgentExecutorTest {

    private TestUnitAgentExecutor testUnitAgentExecutor;
    ...
    void givenReadyToStartLane_whenExecuteLane_thenSubmitTestUnitInput() {
        ...
        final TestUnitPayload payload = new TestUnitPayload(
                "Write unit tests for backend changed files in automationservice-sox",
        ...
        when(this.supervisedExecutionProperties.isSupervisedAgent("test_unit")).thenReturn(false);
        ...
        verify(this.supervisedExecutionProperties).isSupervisedAgent("test_unit");
